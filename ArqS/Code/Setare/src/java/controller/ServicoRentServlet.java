 ...
 * @author JorgeMaia
 */
@WebServlet(name = "ServicoRentServlet", urlPatterns = {"/ServicoRentServlet", "/ServicoRent/index", "/ServicoRent/register"})
public class ServicoRentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userPath.equals("/ServicoRent/index")) {
            request.setAttribute("listalocais", localFacade.findAll());
            request.setAttribute("listacategorias", categoriaFacade.findAll());
            url = "index";
        } else if (userPath.equals("/ServicoRent/regiter")) {
