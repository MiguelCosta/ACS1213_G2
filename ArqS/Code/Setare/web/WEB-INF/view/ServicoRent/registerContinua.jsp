    ...
    <table class="table table-hover"> 
        ...
        <c:forEach var="row" items="${listacarros}"> 
            <tr>
                ...
                <td  style="text-align: center; vertical-align: middle; width: 18%;"><a class="btn btn-large btn-primary" href="<%= request.getContextPath()%>/ServicoRent/registerContinua?id=${row.id}">Reservar !</a></td>
            </tr>
        </c:forEach> 
    </table>
</div>
