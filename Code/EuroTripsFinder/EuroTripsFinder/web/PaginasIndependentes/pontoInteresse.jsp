...
<html>
    <head>
        ...
        <title>Reviews in the Places library</title>
        <script>
    ...
    <body onload="initialize()">
            ...
            <div id="inputfield">
                <input id="query" type="text" placeholder="Enter a query..." onKeyPress="return checkSubmit(event)">
            </div>
            <div>
            </div>
            <div id="map">map div</div>
            <div id="listing" onscroll="reviewsScroll()">
