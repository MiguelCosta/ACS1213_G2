...
CREATE TABLE Companhia (
  id        int(10) NOT NULL comment 'identificador da companhia, corresponde ao formato gtfs: agency->agency_id', 
...
CREATE TABLE MeioTransporte (
  ...
  PRIMARY KEY (id));
CREATE TABLE Viagem (
  id           int(10) NOT NULL comment 'id da viagem', 
...
CREATE TABLE Coordenada (
  id        int(10) NOT NULL comment 'ID da coordenada', 
...
CREATE TABLE LocalParagem (
  id           int(10) NOT NULL comment 'ID da estação', 
